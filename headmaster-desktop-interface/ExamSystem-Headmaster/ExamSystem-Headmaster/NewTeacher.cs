...
namespace ExamSystem_Headmaster
{
    public partial class NewTeacher : Form
    {
        ...
        private void s_submit_Click(object sender, EventArgs e)
        {
            ...
            TeacherDTO body = new TeacherDTO();
            ...
            try
            {
                var httpPOSTrequest = (HttpWebRequest)WebRequest.Create(ExamAPI.TeacherURL);
            ...
            finally
            {
                ...
                {
                    MessageBox.Show("Login Email must be unique and only one teacher can teach specific class!", "Error", MessageBoxButtons.OK);
                }
